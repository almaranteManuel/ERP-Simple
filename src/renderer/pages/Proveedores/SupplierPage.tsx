...
export function SupplierPage() {
  const { suppliers, loading, createSupplier, updateSupplier, deleteSupplier, refresh } = useSuppliers();
  const [showModal, setShowModal] = useState(false);
  const [editingSupplier, setEditingSupplier] = useState<SupplierComplete | null>(null);
  ...
  const handleEdit = (supplier: SupplierComplete) => {
    setEditingSupplier(supplier as SupplierComplete);
    setShowModal(true);
  };
